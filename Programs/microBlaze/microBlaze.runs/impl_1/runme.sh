...
HD_PWD='C:/Users/micro/OneDrive/Documents/GitHub/FPGA-Projects/Programs/microBlaze/microBlaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodDemo_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PmodDemo_wrapper.tcl -notrace
