...
HD_PWD='C:/Users/micro/OneDrive/Documents/GitHub/FPGA-Projects/Programs/microBlaze/microBlaze.runs/PmodDemo_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodDemo_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodDemo_xbar_0.tcl
