...
HD_PWD='C:/Users/micro/OneDrive/Documents/GitHub/FPGA-Projects/Programs/microBlaze/microBlaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodDemo_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodDemo_wrapper.tcl
