...
HD_PWD='C:/Users/Wrelks/FPGA/artyLogicExamples/artyLogicExamples.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simpleAdder.tcl
