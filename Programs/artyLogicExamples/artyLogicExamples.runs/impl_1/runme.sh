...
HD_PWD='C:/Users/Wrelks/FPGA/artyLogicExamples/artyLogicExamples.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simpleAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simpleAdder.tcl -notrace
